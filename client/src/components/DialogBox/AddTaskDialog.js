...
const AddTaskDialog = ({
  ...
  return (
    <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center z-50 bg-black bg-opacity-50">
        ...
        <div className="bg-slate-100 p-8 rounded-xl shadow-lg max-h-full overflow-y-auto w-[600px] max-w-4xl">
          <div className="h-96 overflow-y-auto">
            <h3 className="text-2xl font-semibold mb-4 text-center ">Add New Task</h3>
            <form
              onSubmit={(e) => {
            ...
            >
              ...
              <div className="flex justify-end">
                ...
                <button type="submit"
                className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-700">Add Task</button>
              </div>
            </form>
          </div>
        </div>
